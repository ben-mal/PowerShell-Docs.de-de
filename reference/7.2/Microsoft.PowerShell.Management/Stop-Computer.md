...
In PowerShell 7,1 `Stop-Computer` wurde für Linux und macOS hinzugefügt. Die Parameter haben keine Auswirkung auf diese Plattformen. Das Cmdlet ruft lediglich den systemeigenen Befehl auf `/sbin/shutdown` .
...
In PowerShell 7,1 `Stop-Computer` wurde für Linux und macOS hinzugefügt. Für diese platorms Ruft das Cmdlet den nativen Befehl auf `/sbin/shutdown` .
