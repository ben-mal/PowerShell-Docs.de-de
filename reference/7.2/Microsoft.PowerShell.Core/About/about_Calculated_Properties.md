...
Das- `Measure-Object` Cmdlet berechnet die numerischen Eigenschaften von Objekten. In diesem Beispiel verwenden wir eine berechnete Eigenschaft, um die Anzahl (**Summe**) der Zahlen (zwischen 1 und 10) abzurufen, die gleichmäßig durch 3 teilbar sind.
...
> [!NOTE]
> Im Gegensatz zu anderen-Cmdlets `Measure-Object` akzeptiert keine Hash Tabelle für berechnete Eigenschaften. Sie müssen einen Skriptblock verwenden.
