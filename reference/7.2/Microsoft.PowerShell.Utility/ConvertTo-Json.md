...
Ab PowerShell 7,2 `ConvertTo-Json` gibt eine Warnung aus, wenn die Tiefe des Eingabe Objekts die für den Befehl angegebene Tiefe überschreitet. Dadurch werden unerwünschte Datenverluste beim Umstellen von Objekten verhindert.
...
Gibt an, wie viele Ebenen der enthaltenen Objekte in der JSON-Darstellung enthalten sind. Der Standardwert ist 2. Ab PowerShell 7,2 `ConvertTo-Json` gibt eine Warnung aus, wenn die Anzahl der Ebenen in einem Eingabe Objekt diese Zahl überschreitet.
