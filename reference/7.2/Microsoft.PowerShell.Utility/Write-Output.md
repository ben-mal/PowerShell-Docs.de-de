...
> [!NOTE]
> Dieser Switch funktioniert nur ordnungsgemäß mit PowerShell Core 6,2 und neuer. In älteren Versionen von PowerShell Core wird die Auflistung immer noch durch die Verwendung dieses Schalters aufgezählt.
