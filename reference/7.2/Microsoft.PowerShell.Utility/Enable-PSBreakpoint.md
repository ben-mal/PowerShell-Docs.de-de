...
`Get-PSBreakpoint` Ruft die Breakpoints ab und speichert Sie in der `$B` Variablen. Mit dem  `Enable-PSBreakpoint` breakpointparameter werden die Breakpoints aktiviert.
