...
In diesem Beispiel wird der **excludedifferent** -Parameter verwendet, um die einzelnen Zeilen des Inhalts in zwei Textdateien zu vergleichen.

Ab PowerShell 7,1 wird **includeequal** abgeleitet, wenn der **excludedifferent** -Parameter verwendet wird, und die Ausgabe enthält nur Zeilen, die in beiden Dateien enthalten sind, wie von **sideindicator** ( `==` ) dargestellt.
