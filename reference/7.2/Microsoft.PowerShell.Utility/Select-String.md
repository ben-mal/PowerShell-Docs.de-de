...
Standardmäßig wird `Select-String` die Zeichenfolge, die mit dem Muster übereinstimmt, das  Sie nach dem Muster Parameter gesucht haben, hervorgehoben Der **noakzente** -Parameter deaktiviert die Hervorhebung.
...
Sie können jedes beliebige Objekt über die Pipeline  an übergeben `Select-String` .
