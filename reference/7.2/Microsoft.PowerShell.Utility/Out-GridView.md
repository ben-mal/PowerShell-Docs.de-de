...
|              Taste              |                                   Aktion                                    |
| --------------------------------------- | -------------------------------------------------------------------------------------------- |
| <kbd>TABULATORTASTE</kbd>                          | Verschiebt den Cursor aus dem Feld " **Filter** " in das Menü " **Kriterien hinzufügen** " in die Tabelle und wieder zurück. |
...
- Drücken Sie <kbd>STRG</kbd>A, um alle Zeilen (außer der Kopfzeile) auszuwählen + <kbd></kbd>.
