...
`Get-WinEvent` Listet Ereignisprotokolle und Ereignisprotokoll Anbieter auf. Drücken Sie <kbd>STRG</kbd>C, um den Befehl zu unterbrechen + <kbd></kbd>. Sie können Ereignisse aus ausgewählten Protokollen oder aus von Ereignisanbietern generierten Protokollen abrufen. Und Sie können Ereignisse aus mehreren Quellen in einem einzelnen Befehl kombinieren.
