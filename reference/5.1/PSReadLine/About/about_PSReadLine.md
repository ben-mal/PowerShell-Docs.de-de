...
Löscht die aktuelle Zeile und aktiviert die Rückgängigmachen.

- VI-Befehlsmodus: `<d,d>`

### <a name="deletelinetofirstchar"></a>Delta-inetyp

Löscht Text vom Cursor zum ersten Zeichen der Zeile, das nicht leer ist.
