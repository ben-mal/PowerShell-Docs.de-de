...
Erstellt oder ändert die zentrale Zugriffsrichtlinie (CAP) des Elements.
Geben Sie die CAP-ID oder den Anzeigenamen einer zentralen Zugriffsrichtlinie auf dem Computer ein.

Ab Windows Server 2012 können Administratoren mit Active Directory und Gruppenrichtlinie zentrale Zugriffsrichtlinien für Benutzer und Gruppen festlegen.
Weitere Informationen finden Sie unter [dynamische Access Control: Szenarioübersicht](/windows-server/identity/solution-guides/dynamic-access-control--scenario-overview).
