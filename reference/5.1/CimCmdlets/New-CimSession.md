...
Sie können den Namen verwenden, um auf die CIM-Sitzung zu verweisen, wenn Sie andere Cmdlets verwenden, z [`Get-CimSession`](Get-CimSession.md) . b. das Cmdlet.
...
Gibt den Netzwerkport an dem für diese Verbindung verwendeten Remotecomputer an.
...
Die Standardports sind 5985 (der WinRM-Port für HTTP) und 5986 (der WinRM-Port für HTTPS).
...
Verwenden Sie die folgenden Befehle, um den Listener zu konfigurieren:
