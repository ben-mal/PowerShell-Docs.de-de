...
- Wenn das Typsuffix ist `u` und der Wert durch den Typ dargestellt werden kann, `[int]` ist sein Typ `[int]` .
- Wenn das Typsuffix ist `u` und der Wert durch den Typ dargestellt werden kann, `[long]` ist sein Typ `[long]` .
