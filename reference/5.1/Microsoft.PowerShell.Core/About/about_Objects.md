...
Jede Aktion, die Sie in Windows PowerShell ausführen, findet innerhalb des Kontexts von Objekten statt. Wenn Daten von einem Befehl zum nächsten verschoben werden, werden Sie als ein oder mehrere identifizierbare Objekte verschoben. Bei einem Objekt handelt es sich um eine Auflistung von Daten, die ein Element darstellt. Ein Objekt besteht aus drei Datentypen: dem Objekttyp, seinen Methoden und seinen Eigenschaften.
