...
Weitere Informationen zu PowerShell-Snap-Ins finden Sie unter [about_PSSnapins](about_PSSnapins.md).
...
Sie können auch eine Gruppenrichtlinie Einstellung, die Modul Protokollierung aktivieren, verwenden, um die Modul Protokollierung in allen PowerShell-Sitzungen zu aktivieren. Weitere Informationen finden Sie unter [about_EventLogs](about_EventLogs.md) und [about_Group_Policy_Settings](about_Group_Policy_Settings.md).
