...
## <a name="update-help-in-the-powershell-ise"></a>Aktualisieren der Hilfe in der PowerShell ISE

Sie können die Hilfe auch aktualisieren, indem Sie das **PowerShell-Hilfe Element aktualisieren** im Menü Hilfe in PowerShell Integrated Scripting Environment (ISE) verwenden.

Das **PowerShell-Hilfe Element aktualisieren** führt einen `Update-Help` Befehl ohne Parameter aus.
...
> [!NOTE]
> Aktuell werden aktualisierbare Hilfe Inhalte nur in englischer Sprache (en-US) veröffentlicht.
