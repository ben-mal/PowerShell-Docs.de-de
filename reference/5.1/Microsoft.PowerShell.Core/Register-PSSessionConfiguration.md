...
Gibt den Typ der Sitzung an, die mit der Sitzungskonfiguration erstellt wird. Zulässige Werte für diesen Parameter:

- Leer. Der Sitzung werden standardmäßig keine Module hinzugefügt. Verwenden Sie die Parameter dieses Cmdlets, um der Sitzung Module, Funktionen, Skripts und andere Funktionen hinzuzufügen.
- Standard. Fügt der Sitzung Microsoft. PowerShell. Core hinzu. Dieses Modul enthält das `Import-Module` Cmdlet, das Benutzer verwenden können, um andere Module zu importieren, es sei denn, Sie verbieten das Cmdlet explizit.
- RestrictedRemoteServer. Schließt nur die folgenden Cmdlets ein: `Exit-PSSession` , `Get-Command` , `Get-FormatData` , `Get-Help` , `Measure-Object` , `Out-Default` und `Select-Object` . Verwenden Sie ein Skript oder eine Assembly oder die Schlüssel in der Sitzungskonfigurationsdatei, um der Sitzung Module, Funktionen, Skripts und andere Funktionen hinzuzufügen.

Der Standardwert ist Default.

Der Wert dieses Parameters hat Vorrang vor dem Wert des **SessionType** -Schlüssels in der Sitzungs Konfigurationsdatei.
...
Gibt den Apartment Zustand der Threads in der Sitzung an.
