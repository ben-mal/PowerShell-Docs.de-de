...
Wenn eine Leerzeichen-Zeichenfolge für den-Parameter bereitgestellt wird `-Path` , wird **true** zurückgegeben. Wenn eine leere Zeichenfolge bereitgestellt wird, `Test-Path` gibt einen Fehler zurück. Das folgende Beispiel zeigt Leerräume und eine leere Zeichenfolge.
...
Der `Test-Path` ist für die Arbeit mit den Daten konzipiert, die von beliebigen Anbietern verfügbar gemacht werden.
