...
Gibt an, welches Protokoll zum Umbenennen des Computers verwendet werden soll.
Die zulässigen Werte für diesen Parameter sind: WSMAN und DCOM.
Der Standardwert ist DCOM.
