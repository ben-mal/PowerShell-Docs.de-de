...
Um einen neuen Alias zu erstellen, verwenden Sie `Set-Alias` oder `New-Alias` . Um einen Alias zu entfernen, verwenden Sie das- `Remove-Item` Cmdlet. Beispiel: `Remove-Item -Path Alias:aliasname`.
