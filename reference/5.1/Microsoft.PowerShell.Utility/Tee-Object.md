...
`Tee-Object` verwendet die Unicode-Codierung (UTF-16LE) beim Schreiben in Dateien. Wenn Sie eine andere Codierung benötigen, verwenden Sie das- `Out-File` Cmdlet mit dem **Encoding** -Parameter.
