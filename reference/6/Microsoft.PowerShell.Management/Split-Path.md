...
Gibt an, dass dieses Cmdlet nur die Erweiterung des Blatts zurückgibt.
Im Pfad wird beispielsweise `C:\Test\Logs\Pass1.log` nur zurückgegeben `.log` .
...
Gibt an, dass dieses Cmdlet nur den Basis Namen des Blatts zurückgibt.
Im Pfad wird beispielsweise `C:\Test\Logs\Pass1.log` nur zurückgegeben `Pass1` .
