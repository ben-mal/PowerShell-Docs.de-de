...
Gibt den aufzulösenden PowerShell-Pfad an. Dieser Parameter ist erforderlich. Sie können eine Pfad Zeichenfolge auch über die Pipeline an übergeben `Resolve-Path` . Platzhalterzeichen sind zulässig.
