...
- <span data-ttu-id="2eb89-121">`Get-Alias` : Ruft alle Aliase in der aktuellen Sitzung ab.</span><span class="sxs-lookup"><span data-stu-id="2eb89-121">`Get-Alias` - Gets all the aliases in the current session.</span></span>
