...
`New-ModuleManifest` erstellt Modul Manifest ( `.psd1` )-Dateien, die wie folgt codiert werden:
...
- PowerShell 6,1 und höher, die auf Windows-und nicht-Windows-Plattformen ausgeführt werden, verwenden **UTF8NoBOM**.
