...
PowerShell Core unterstützt das PowerShell-Remoting (PSRP) ebenfalls auf allen Plattformen (Windows, macOS, Linux) über SSH. Dies wird derzeit nicht in der Produktion unterstützt, [hier](/powershell/scripting/learn/remoting/SSH-Remoting-in-PowerShell-Core) können Sie jedoch mehr über die Einrichtung erfahren.
