...
|---|---|
|**Append**<br>Datentyp: Switchparameter|Implementieren Sie diesen Parameter, sodass der Benutzer Inhalt am Ende einer Ressource hinzufügen kann, wenn der-Parameter angegeben wird.|
...
|**Einfügen**<br>Datentyp: Switchparameter|Implementieren Sie diesen Parameter, damit das Cmdlet ein Element einfügt, wenn der Parameter angegeben wird.|
...
|**Benachrichtigen**<br>Datentyp: Switchparameter|Implementieren Sie diesen Parameter, sodass der Benutzer benachrichtigt wird, dass die Aktivität beendet ist, wenn der-Parameter angegeben wird.|
