...
Die aufgezählten Werte sind im **.NET Framework** dokumentiert. Weitere Informationen finden Sie unter [StandardEventKeywords Enumeration](/dotnet/api/system.diagnostics.eventing.reader.standardeventkeywords).
...
Die aufgezählten Werte sind im **.NET Framework** dokumentiert. Weitere Informationen finden Sie unter [StandardEventLevel Enumeration](/dotnet/api/system.diagnostics.eventing.reader.standardeventlevel).
