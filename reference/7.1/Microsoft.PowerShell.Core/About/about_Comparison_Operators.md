...
Ab PowerShell 6 können Sie ein **ScriptBlock** -Argument *für den* Ersetzungstext verwenden. Der **ScriptBlock** wird für jede in der *Eingabe* Zeichenfolge gefundene Entsprechung ausgeführt.
