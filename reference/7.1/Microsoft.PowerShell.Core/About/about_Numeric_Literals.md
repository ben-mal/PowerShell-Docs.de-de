...
In PowerShell 7,1 gibt die Verwendung eines typsuffixes für ein hexadezimal Literale nun einen signierten Wert dieses Typs zurück. Beispielsweise gibt der Ausdruck in PowerShell 7,0 `0xFFFFs` einen Fehler zurück, da der positive Wert für einen-Typ zu groß ist `[int16]` .
