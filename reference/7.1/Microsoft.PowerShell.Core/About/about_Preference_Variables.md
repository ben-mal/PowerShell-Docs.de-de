...
<span data-ttu-id="1c2f9-112">In der folgenden Tabelle sind die Einstellungs Variablen und ihre Standardwerte aufgeführt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-112">The following table lists the preference variables and their default values.</span></span>
...
<span data-ttu-id="1c2f9-196">Die folgenden Werte sind gültig:</span><span class="sxs-lookup"><span data-stu-id="1c2f9-196">The valid values are as follows:</span></span>
...
<span data-ttu-id="1c2f9-227">Sie können den allgemeinen **ErrorAction** -Parameter eines Cmdlets verwenden, um die Einstellung für einen bestimmten Befehl zu überschreiben.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-227">You can use a cmdlet's **ErrorAction** common parameter to override the preference for a specific command.</span></span>
...
<span data-ttu-id="1c2f9-254">Dieses Beispiel zeigt `$ErrorActionPreference` , dass auf **SilentlyContinue** festgelegt ist.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-254">This example shows the `$ErrorActionPreference` set to **SilentlyContinue**.</span></span>
...
### <a name="errorview"></a><span data-ttu-id="1c2f9-258">\$Errorview</span><span class="sxs-lookup"><span data-stu-id="1c2f9-258">\$ErrorView</span></span>
...
### <a name="formatenumerationlimit"></a><span data-ttu-id="1c2f9-286">\$Formatenumerationlimit</span><span class="sxs-lookup"><span data-stu-id="1c2f9-286">\$FormatEnumerationLimit</span></span>
...
<span data-ttu-id="1c2f9-299">Suchen Sie den aktuellen Wert von `$FormatEnumerationLimit` .</span><span class="sxs-lookup"><span data-stu-id="1c2f9-299">Find the current value of `$FormatEnumerationLimit`.</span></span>
...
### <a name="logevent"></a><span data-ttu-id="1c2f9-317">\$Log \*-Ereignis</span><span class="sxs-lookup"><span data-stu-id="1c2f9-317">\$Log\*Event</span></span>
...
<span data-ttu-id="1c2f9-335">Um ein \**Log *-Ereignis** zu aktivieren, geben Sie die Variable mit dem Wert ein, z. b. `$true` :</span><span class="sxs-lookup"><span data-stu-id="1c2f9-335">To enable a **Log\*Event** , type the variable with a value of `$true`, for example:</span></span>
...
<span data-ttu-id="1c2f9-368">Der erste Befehl sucht den Wert von `$OutputEncoding` .</span><span class="sxs-lookup"><span data-stu-id="1c2f9-368">The first command finds the value of `$OutputEncoding`.</span></span> <span data-ttu-id="1c2f9-369">Da der Wert ein Codierungs Objekt ist, zeigen Sie nur seine **EncodingName** -Eigenschaft an.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-369">Because the value is an encoding object, display only its **EncodingName** property.</span></span>
...
### <a name="progresspreference"></a><span data-ttu-id="1c2f9-376">\$ProgressPreference</span><span class="sxs-lookup"><span data-stu-id="1c2f9-376">\$ProgressPreference</span></span>
...
<span data-ttu-id="1c2f9-391">Gibt die Standardwerte für die Parameter von Cmdlets und erweiterten Funktionen an.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-391">Specifies default values for the parameters of cmdlets and advanced functions.</span></span>
...
- <span data-ttu-id="1c2f9-404">**Modulequalified** : Module werden nur dann automatisch importiert, wenn ein Benutzer das Modul qualifizierte Name eines Befehls im Modul verwendet.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-404">**ModuleQualified** : Modules are imported automatically only when a user uses the module-qualified name of a command in the module.</span></span> <span data-ttu-id="1c2f9-405">Wenn der Benutzer z. b. eingibt `MyModule\MyCommand` , importiert PowerShell das **MyModule** -Modul.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-405">For example, if the user types `MyModule\MyCommand`, PowerShell imports the **MyModule** module.</span></span>
- <span data-ttu-id="1c2f9-406">**Keine** : der automatische Import von Modulen ist in der Sitzung deaktiviert.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-406">**None** : Automatic importing of modules is disabled in the session.</span></span> <span data-ttu-id="1c2f9-407">Verwenden Sie das-Cmdlet, um ein Modul zu importieren `Import-Module` .</span><span class="sxs-lookup"><span data-stu-id="1c2f9-407">To import a module, use the `Import-Module` cmdlet.</span></span>

<span data-ttu-id="1c2f9-408">Weitere Informationen zum automatischen Importieren von Modulen finden Sie unter [about_Modules](about_Modules.md).</span><span class="sxs-lookup"><span data-stu-id="1c2f9-408">For more information about automatic importing of modules, see [about_Modules](about_Modules.md).</span></span>

### <a name="pssessionapplicationname"></a><span data-ttu-id="1c2f9-409">\$PSSessionApplicationName</span><span class="sxs-lookup"><span data-stu-id="1c2f9-409">\$PSSessionApplicationName</span></span>

<span data-ttu-id="1c2f9-410">Gibt den Standard Anwendungsnamen für einen Remote Befehl an, der die Web Services for Management (WS-Management)-Technologie verwendet.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-410">Specifies the default application name for a remote command that uses Web Services for Management (WS-Management) technology.</span></span> <span data-ttu-id="1c2f9-411">Weitere Informationen finden Sie unter Informationen [zu Windows-Remoteverwaltung](/windows/win32/winrm/about-windows-remote-management).</span><span class="sxs-lookup"><span data-stu-id="1c2f9-411">For more information, see [About Windows Remote Management](/windows/win32/winrm/about-windows-remote-management).</span></span>

<span data-ttu-id="1c2f9-412">Der Standard Anwendungsname des Systems ist `WSMAN` , aber Sie können diese Einstellungs Variable verwenden, um den Standardwert zu ändern.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-412">The system default application name is `WSMAN`, but you can use this preference variable to change the default.</span></span>

<span data-ttu-id="1c2f9-413">Der Anwendungsname ist der letzte Knoten in einem Verbindungs-URI.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-413">The application name is the last node in a connection URI.</span></span> <span data-ttu-id="1c2f9-414">Der Anwendungsname im folgenden Beispiel-URI lautet z. b `WSMAN` ..</span><span class="sxs-lookup"><span data-stu-id="1c2f9-414">For example, the application name in the following sample URI is `WSMAN`.</span></span>

`http://Server01:8080/WSMAN`

<span data-ttu-id="1c2f9-415">Der Standard Anwendungsname wird verwendet, wenn der Remote Befehl keinen Verbindungs-URI oder Anwendungsnamen angibt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-415">The default application name is used when the remote command doesn't specify a connection URI or an application name.</span></span>

<span data-ttu-id="1c2f9-416">Der **WinRM** -Dienst wählt mit dem Anwendungsnamen einen Listener für die Verbindungsanforderung aus.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-416">The **WinRM** service uses the application name to select a listener to service the connection request.</span></span> <span data-ttu-id="1c2f9-417">Der Wert des Parameters sollte mit dem Wert der **URLPrefix** -Eigenschaft eines Listener auf dem Remote Computer identisch sein.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-417">The parameter's value should match the value of the **URLPrefix** property of a listener on the remote computer.</span></span>

<span data-ttu-id="1c2f9-418">Verwenden Sie die Parameter **ConnectionUri** oder **ApplicationName** der Cmdlets [New-PSSession](xref:Microsoft.PowerShell.Core.New-PSSession), [Enter-PSSession](xref:Microsoft.PowerShell.Core.Enter-PSSession)oder [aufrufen-Command](xref:Microsoft.PowerShell.Core.Invoke-Command) , um die System Standardwerte und den Wert dieser Variablen zu überschreiben und einen anderen Anwendungsnamen für eine bestimmte Sitzung auszuwählen.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-418">To override the system default and the value of this variable, and select a different application name for a particular session, use the **ConnectionURI** or **ApplicationName** parameters of the [New-PSSession](xref:Microsoft.PowerShell.Core.New-PSSession), [Enter-PSSession](xref:Microsoft.PowerShell.Core.Enter-PSSession), or [Invoke-Command](xref:Microsoft.PowerShell.Core.Invoke-Command) cmdlets.</span></span>

<span data-ttu-id="1c2f9-419">Die Einstellungs `$PSSessionApplicationName` Variable wird auf dem lokalen Computer festgelegt, aber Sie gibt einen Listener auf dem Remote Computer an.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-419">The `$PSSessionApplicationName` preference variable is set on the local computer, but it specifies a listener on the remote computer.</span></span> <span data-ttu-id="1c2f9-420">Wenn der angegebene Anwendungsname auf dem Remote Computer nicht vorhanden ist, schlägt der Befehl zum Einrichten der Sitzung fehl.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-420">If the application name that you specify doesn't exist on the remote computer, the command to establish the session fails.</span></span>

### <a name="pssessionconfigurationname"></a><span data-ttu-id="1c2f9-421">\$PSSessionConfigurationName</span><span class="sxs-lookup"><span data-stu-id="1c2f9-421">\$PSSessionConfigurationName</span></span>

<span data-ttu-id="1c2f9-422">Gibt die Standard Sitzungs Konfiguration an, die für die in der aktuellen Sitzung erstellten **pssessions** verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-422">Specifies the default session configuration that is used for **PSSessions** created in the current session.</span></span>

<span data-ttu-id="1c2f9-423">Diese Einstellungs Variable wird auf dem lokalen Computer festgelegt, aber Sie gibt eine Sitzungs Konfiguration an, die sich auf dem Remote Computer befindet.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-423">This preference variable is set on the local computer, but it specifies a session configuration that's located on the remote computer.</span></span>

<span data-ttu-id="1c2f9-424">Der Wert der `$PSSessionConfigurationName` Variablen ist ein voll qualifizierter Ressourcen-URI.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-424">The value of the `$PSSessionConfigurationName` variable is a fully qualified resource URI.</span></span>

<span data-ttu-id="1c2f9-425">Der Standardwert `http://schemas.microsoft.com/PowerShell/microsoft.PowerShell` gibt die **Microsoft. PowerShell** -Sitzungs Konfiguration auf dem Remote Computer an.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-425">The default value `http://schemas.microsoft.com/PowerShell/microsoft.PowerShell` indicates the **Microsoft.PowerShell** session configuration on the remote computer.</span></span>

<span data-ttu-id="1c2f9-426">Wenn Sie nur einen Konfigurations Namen angeben, wird der folgende Schema-URI vorangestellt:</span><span class="sxs-lookup"><span data-stu-id="1c2f9-426">If you specify only a configuration name, the following schema URI is prepended:</span></span>

`http://schemas.microsoft.com/PowerShell/`

<span data-ttu-id="1c2f9-427">Sie können den Standardwert überschreiben und eine andere Sitzungs Konfiguration für eine bestimmte Sitzung auswählen, indem Sie den **ConfigurationName** -Parameter der `New-PSSession` `Enter-PSSession` `Invoke-Command` Cmdlets, oder verwenden.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-427">You can override the default and select a different session configuration for a particular session by using the **ConfigurationName** parameter of the `New-PSSession`, `Enter-PSSession`, or `Invoke-Command` cmdlets.</span></span>

<span data-ttu-id="1c2f9-428">Sie können den Wert dieser Variablen jederzeit ändern.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-428">You can change the value of this variable at any time.</span></span> <span data-ttu-id="1c2f9-429">Beachten Sie dabei, dass die ausgewählte Sitzungs Konfiguration auf dem Remote Computer vorhanden sein muss.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-429">When you do, remember that the session configuration that you select must exist on the remote computer.</span></span> <span data-ttu-id="1c2f9-430">Wenn dies nicht der Fall ist, schlägt der Befehl zum Erstellen einer Sitzung fehl, die die Sitzungs Konfiguration verwendet.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-430">If it doesn't, the command to create a session that uses the session configuration fails.</span></span>

<span data-ttu-id="1c2f9-431">Diese Einstellungs Variable bestimmt nicht, welche lokalen Sitzungs Konfigurationen verwendet werden, wenn Remote Benutzer eine Sitzung erstellen, die eine Verbindung mit diesem Computer herstellt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-431">This preference variable doesn't determine which local session configurations are used when remote users create a session that connects to this computer.</span></span>
<span data-ttu-id="1c2f9-432">Sie können jedoch die Berechtigungen für die lokalen Sitzungs Konfigurationen verwenden, um zu bestimmen, welche Benutzer Sie verwenden dürfen.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-432">However, you can use the permissions for the local session configurations to determine which users may use them.</span></span>

### <a name="pssessionoption"></a><span data-ttu-id="1c2f9-433">\$PSSessionOption</span><span class="sxs-lookup"><span data-stu-id="1c2f9-433">\$PSSessionOption</span></span>

<span data-ttu-id="1c2f9-434">Legt die Standardwerte für erweiterte Benutzeroptionen in einer Remote Sitzung fest.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-434">Establishes the default values for advanced user options in a remote session.</span></span>
<span data-ttu-id="1c2f9-435">Diese Options Einstellungen überschreiben die System Standardwerte für Sitzungs Optionen.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-435">These option preferences override the system default values for session options.</span></span>

<span data-ttu-id="1c2f9-436">Die `$PSSessionOption` Variable enthält ein **pssessionoption** -Objekt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-436">The `$PSSessionOption` variable contains a **PSSessionOption** object.</span></span> <span data-ttu-id="1c2f9-437">Weitere Informationen finden Sie unter " [System. Management. Automation. Remoting. pssessionoption](/dotnet/api/system.management.automation.remoting.pssessionoption)".</span><span class="sxs-lookup"><span data-stu-id="1c2f9-437">For more information, see [System.Management.Automation.Remoting.PSSessionOption](/dotnet/api/system.management.automation.remoting.pssessionoption).</span></span>
<span data-ttu-id="1c2f9-438">Jede Eigenschaft des-Objekts stellt eine Sitzungs Option dar.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-438">Each property of the object represents a session option.</span></span> <span data-ttu-id="1c2f9-439">Beispielsweise wandelt die **NoCompression** -Eigenschaft die Datenkomprimierung während der Sitzung um.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-439">For example, the **NoCompression** property turns of data compression during the session.</span></span>

<span data-ttu-id="1c2f9-440">Standardmäßig enthält die `$PSSessionOption` Variable ein **pssessionoption** -Objekt mit den Standardwerten für alle Optionen, wie unten gezeigt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-440">By default, the `$PSSessionOption` variable contains a **PSSessionOption** object with the default values for all options, as shown below.</span></span>
...
<span data-ttu-id="1c2f9-441">Beschreibungen dieser Optionen und weitere Informationen finden Sie unter [New-pssessionoption](xref:Microsoft.PowerShell.Core.New-PSSessionOption).</span><span class="sxs-lookup"><span data-stu-id="1c2f9-441">For descriptions of these options and more information, see [New-PSSessionOption](xref:Microsoft.PowerShell.Core.New-PSSessionOption).</span></span> <span data-ttu-id="1c2f9-442">Weitere Informationen zu Remote Befehlen und-Sitzungen finden Sie unter [about_Remote](about_Remote.md) und [about_PSSessions](about_PSSessions.md).</span><span class="sxs-lookup"><span data-stu-id="1c2f9-442">For more information about remote commands and sessions, see [about_Remote](about_Remote.md) and [about_PSSessions](about_PSSessions.md).</span></span>

<span data-ttu-id="1c2f9-443">Um den Wert der Preference- `$PSSessionOption` Variablen zu ändern, verwenden `New-PSSessionOption` Sie das Cmdlet zum Erstellen eines **pssessionoption** -Objekts mit den von Ihnen bevorzugten Options Werten.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-443">To change the value of the `$PSSessionOption` preference variable, use the `New-PSSessionOption` cmdlet to create a **PSSessionOption** object with the option values you prefer.</span></span> <span data-ttu-id="1c2f9-444">Speichern Sie die Ausgabe in einer Variablen mit dem Namen `$PSSessionOption` .</span><span class="sxs-lookup"><span data-stu-id="1c2f9-444">Save the output in a variable called `$PSSessionOption`.</span></span>

```powershell
$PSSessionOption = New-PSSessionOption -NoCompression
```

<span data-ttu-id="1c2f9-445">Wenn Sie die Einstellungs `$PSSessionOption` Variable in jeder PowerShell-Sitzung verwenden möchten, fügen Sie einen `New-PSSessionOption` Befehl hinzu, mit dem die Variable in `$PSSessionOption` Ihrem PowerShell-Profil erstellt wird.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-445">To use the `$PSSessionOption` preference variable in every PowerShell session, add a `New-PSSessionOption` command that creates the `$PSSessionOption` variable to your PowerShell profile.</span></span> <span data-ttu-id="1c2f9-446">Weitere Informationen finden Sie unter [about_Profiles](about_Profiles.md).</span><span class="sxs-lookup"><span data-stu-id="1c2f9-446">For more information, see [about_Profiles](about_Profiles.md).</span></span>

<span data-ttu-id="1c2f9-447">Sie können benutzerdefinierte Optionen für eine bestimmte Remote Sitzung festlegen.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-447">You can set custom options for a particular remote session.</span></span> <span data-ttu-id="1c2f9-448">Die von Ihnen festgelegten Optionen haben Vorrang vor den System Standardwerten und dem Wert der `$PSSessionOption` Preference-Variablen.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-448">The options that you set take precedence over the system defaults and the value of the `$PSSessionOption` preference variable.</span></span>

<span data-ttu-id="1c2f9-449">Verwenden Sie das `New-PSSessionOption` Cmdlet zum Erstellen eines **pssessionoption** -Objekts, um benutzerdefinierte Sitzungs Optionen festzulegen.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-449">To set custom session options, use the `New-PSSessionOption` cmdlet to create a **PSSessionOption** object.</span></span> <span data-ttu-id="1c2f9-450">Verwenden Sie dann das **pssessionoption** -Objekt als Wert des **sessionoption** -Parameters in Cmdlets, die eine Sitzung erstellen, `New-PSSession` z `Enter-PSSession` . b `Invoke-Command` ., und.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-450">Then, use the **PSSessionOption** object as the value of the **SessionOption** parameter in cmdlets that create a session, such as `New-PSSession`, `Enter-PSSession`, and `Invoke-Command`.</span></span>

### <a name="transcript"></a><span data-ttu-id="1c2f9-451">$Transcript</span><span class="sxs-lookup"><span data-stu-id="1c2f9-451">$Transcript</span></span>

<span data-ttu-id="1c2f9-452">Wird von verwendet `Start-Transcript` , um den Namen und den Speicherort der Transkriptions Datei anzugeben.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-452">Used by `Start-Transcript` to specify the name and location of the transcript file.</span></span> <span data-ttu-id="1c2f9-453">Wenn Sie keinen Wert für den **path** -Parameter angeben, wird `Start-Transcript` von der Pfad im Wert der `$Transcript` globalen Variablen verwendet.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-453">If you do not specify a value for the **Path** parameter, `Start-Transcript` uses the path in the value of the `$Transcript` global variable.</span></span> <span data-ttu-id="1c2f9-454">Wenn Sie diese Variable nicht erstellt haben, `Start-Transcript` speichert die Transkriptionen `$Home\My Documents` als Dateien im Verzeichnis `\PowerShell_transcript.<time-stamp>.txt` .</span><span class="sxs-lookup"><span data-stu-id="1c2f9-454">If you have not created this variable, `Start-Transcript` stores the transcripts in the `$Home\My Documents` directory as `\PowerShell_transcript.<time-stamp>.txt` files.</span></span>

### <a name="verbosepreference"></a><span data-ttu-id="1c2f9-455">\$VerbosePreference</span><span class="sxs-lookup"><span data-stu-id="1c2f9-455">\$VerbosePreference</span></span>

<span data-ttu-id="1c2f9-456">Bestimmt, wie PowerShell auf ausführliche Meldungen antwortet, die von einem Skript, einem Cmdlet oder einem Anbieter generiert werden, z. b. die vom [Write-ausführliche-](xref:Microsoft.PowerShell.Utility.Write-Verbose) Cmdlet generierten Meldungen.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-456">Determines how PowerShell responds to verbose messages generated by a script, cmdlet, or provider, such as the messages generated by the [Write-Verbose](xref:Microsoft.PowerShell.Utility.Write-Verbose) cmdlet.</span></span>
<span data-ttu-id="1c2f9-457">Ausführliche Meldungen beschreiben die Aktionen, die zum Ausführen eines Befehls ausgeführt werden.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-457">Verbose messages describe the actions performed to execute a command.</span></span>

<span data-ttu-id="1c2f9-458">Standardmäßig werden ausführliche Meldungen nicht angezeigt. Sie können dieses Verhalten jedoch ändern, indem Sie den Wert von ändern `$VerbosePreference` .</span><span class="sxs-lookup"><span data-stu-id="1c2f9-458">By default, verbose messages aren't displayed, but you can change this behavior by changing the value of `$VerbosePreference`.</span></span>

<span data-ttu-id="1c2f9-459">Sie können den allgemeinen **ausführliche** -Parameter eines Cmdlets verwenden, um die ausführlichen Meldungen für einen bestimmten Befehl anzuzeigen oder auszublenden.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-459">You can use the **Verbose** common parameter of a cmdlet to display or hide the verbose messages for a specific command.</span></span> <span data-ttu-id="1c2f9-460">Weitere Informationen findest du unter [about_CommonParameters](about_CommonParameters.md).</span><span class="sxs-lookup"><span data-stu-id="1c2f9-460">For more information, see [about_CommonParameters](about_CommonParameters.md).</span></span>

<span data-ttu-id="1c2f9-461">Die folgenden Werte sind gültig:</span><span class="sxs-lookup"><span data-stu-id="1c2f9-461">The valid values are as follows:</span></span>

- <span data-ttu-id="1c2f9-462">**Beenden** : zeigt die ausführliche Meldung und eine Fehlermeldung an und beendet dann die Ausführung.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-462">**Stop** : Displays the verbose message and an error message and then stops executing.</span></span>
- <span data-ttu-id="1c2f9-463">**Anfragen** : zeigt die ausführliche Meldung an und zeigt dann eine Eingabeaufforderung an, in der Sie gefragt werden, ob Sie den Vorgang fortsetzen möchten.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-463">**Inquire** : Displays the verbose message and then displays a prompt that asks you whether you want to continue.</span></span>
- <span data-ttu-id="1c2f9-464">**Continue** : zeigt die ausführliche Meldung an und wird dann mit der Ausführung fortgesetzt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-464">**Continue** : Displays the verbose message and then continues with execution.</span></span>
- <span data-ttu-id="1c2f9-465">**SilentlyContinue** : (Standard) zeigt die ausführliche Meldung nicht an.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-465">**SilentlyContinue** : (Default) Doesn't display the verbose message.</span></span> <span data-ttu-id="1c2f9-466">Setzt die Ausführung fort.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-466">Continues executing.</span></span>

#### <a name="examples"></a><span data-ttu-id="1c2f9-467">Beispiele</span><span class="sxs-lookup"><span data-stu-id="1c2f9-467">Examples</span></span>

<span data-ttu-id="1c2f9-468">Diese Beispiele zeigen die Auswirkung der unterschiedlichen Werte von `$VerbosePreference` und des **verbose** -Parameters, um den Preference-Wert zu überschreiben.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-468">These examples show the effect of the different values of `$VerbosePreference` and the **Verbose** parameter to override the preference value.</span></span>

<span data-ttu-id="1c2f9-469">Dieses Beispiel zeigt die Auswirkung des **SilentlyContinue** -Werts, der Standardwert ist.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-469">This example shows the effect of the **SilentlyContinue** value, that is the default.</span></span> <span data-ttu-id="1c2f9-470">Der Befehl verwendet den **Message** -Parameter, schreibt jedoch keine Nachricht in die PowerShell-Konsole.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-470">The command uses the **Message** parameter, but doesn't write a message to the PowerShell console.</span></span>

```powershell
Write-Verbose -Message "Verbose message test."
```

<span data-ttu-id="1c2f9-471">Wenn der **verbose** -Parameter verwendet wird, wird die Nachricht geschrieben.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-471">When the **Verbose** parameter is used, the message is written.</span></span>
...
<span data-ttu-id="1c2f9-472">Dieses Beispiel zeigt die Auswirkung des **Continue** -Werts.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-472">This example shows the effect of the **Continue** value.</span></span> <span data-ttu-id="1c2f9-473">Die `$VerbosePreference` Variable wird auf **Continue** festgelegt, und die Meldung wird angezeigt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-473">The `$VerbosePreference` variable is set to **Continue** and the message is displayed.</span></span>
...
<span data-ttu-id="1c2f9-474">In diesem Beispiel wird der **verbose** -Parameter mit dem Wert verwendet `$false` , der den **Continue** -Wert überschreibt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-474">This example uses the **Verbose** parameter with a value of `$false` that overrides the **Continue** value.</span></span> <span data-ttu-id="1c2f9-475">Die Meldung wird nicht angezeigt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-475">The message isn't displayed.</span></span>

```powershell
Write-Verbose -Message "Verbose message test." -Verbose:$false
```

<span data-ttu-id="1c2f9-476">Dieses Beispiel zeigt die Auswirkung des **Stoppwerts** .</span><span class="sxs-lookup"><span data-stu-id="1c2f9-476">This example shows the effect of the **Stop** value.</span></span> <span data-ttu-id="1c2f9-477">Die `$VerbosePreference` Variable wird auf "wird **beendet** " festgelegt, und die Meldung wird angezeigt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-477">The `$VerbosePreference` variable is set to **Stop** and the message is displayed.</span></span> <span data-ttu-id="1c2f9-478">Der Befehl wurde beendet.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-478">The command is stopped.</span></span>
...
<span data-ttu-id="1c2f9-479">In diesem Beispiel wird der **verbose** -Parameter mit dem Wert verwendet `$false` , der den **Endwert** überschreibt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-479">This example uses the **Verbose** parameter with a value of `$false` that overrides the **Stop** value.</span></span> <span data-ttu-id="1c2f9-480">Die Meldung wird nicht angezeigt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-480">The message isn't displayed.</span></span>

```powershell
Write-Verbose -Message "Verbose message test." -Verbose:$false
```

<span data-ttu-id="1c2f9-481">Dieses Beispiel **zeigt die Auswirkung des Werts "** suchen".</span><span class="sxs-lookup"><span data-stu-id="1c2f9-481">This example shows the effect of the **Inquire** value.</span></span> <span data-ttu-id="1c2f9-482">Die `$VerbosePreference` Variable wird auf " **Anfragen** " festgelegt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-482">The `$VerbosePreference` variable is set to **Inquire**.</span></span> <span data-ttu-id="1c2f9-483">Die Meldung wird angezeigt, und der Benutzer wird zur Bestätigung aufgefordert.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-483">The message is displayed and the user is prompted for confirmation.</span></span>
...
<span data-ttu-id="1c2f9-484">In diesem Beispiel wird der **verbose** -Parameter mit dem Wert verwendet, der den Wert "suchen" `$false` überschreibt. **Inquire**</span><span class="sxs-lookup"><span data-stu-id="1c2f9-484">This example uses the **Verbose** parameter with a value of `$false` that overrides the **Inquire** value.</span></span> <span data-ttu-id="1c2f9-485">Der Benutzer wird nicht zur Eingabe aufgefordert, und die Meldung wird nicht angezeigt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-485">The user isn't prompted and the message isn't displayed.</span></span>

```powershell
Write-Verbose -Message "Verbose message test." -Verbose:$false
```

### <a name="warningpreference"></a><span data-ttu-id="1c2f9-486">\$WarningPreference</span><span class="sxs-lookup"><span data-stu-id="1c2f9-486">\$WarningPreference</span></span>

<span data-ttu-id="1c2f9-487">Bestimmt, wie PowerShell auf Warnmeldungen antwortet, die von einem Skript, einem Cmdlet oder einem Anbieter generiert werden, z. b. die vom Cmdlet " [Write-Warning](xref:Microsoft.PowerShell.Utility.Write-Warning) " generierten Meldungen.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-487">Determines how PowerShell responds to warning messages generated by a script, cmdlet, or provider, such as the messages generated by the [Write-Warning](xref:Microsoft.PowerShell.Utility.Write-Warning) cmdlet.</span></span>

<span data-ttu-id="1c2f9-488">Standardmäßig werden Warnmeldungen angezeigt, und die Ausführung wird fortgesetzt. Sie können dieses Verhalten jedoch ändern, indem Sie den Wert von ändern `$WarningPreference` .</span><span class="sxs-lookup"><span data-stu-id="1c2f9-488">By default, warning messages are displayed and execution continues, but you can change this behavior by changing the value of `$WarningPreference`.</span></span>

<span data-ttu-id="1c2f9-489">Sie können den allgemeinen **WarningAction** -Parameter eines Cmdlets verwenden, um zu bestimmen, wie PowerShell auf Warnungen von einem bestimmten Befehl antwortet.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-489">You can use the **WarningAction** common parameter of a cmdlet to determine how PowerShell responds to warnings from a particular command.</span></span> <span data-ttu-id="1c2f9-490">Weitere Informationen findest du unter [about_CommonParameters](about_CommonParameters.md).</span><span class="sxs-lookup"><span data-stu-id="1c2f9-490">For more information, see [about_CommonParameters](about_CommonParameters.md).</span></span>

<span data-ttu-id="1c2f9-491">Die folgenden Werte sind gültig:</span><span class="sxs-lookup"><span data-stu-id="1c2f9-491">The valid values are as follows:</span></span>

- <span data-ttu-id="1c2f9-492">**Beenden** : zeigt die Warnmeldung und eine Fehlermeldung an und beendet dann die Ausführung.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-492">**Stop** : Displays the warning message and an error message and then stops executing.</span></span>
- <span data-ttu-id="1c2f9-493">**Erkundigen** : zeigt die Warnmeldung an und fordert dann die Berechtigung zum Fortfahren auf.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-493">**Inquire** : Displays the warning message and then prompts for permission to continue.</span></span>
- <span data-ttu-id="1c2f9-494">**Continue** (Standard): zeigt die Warnmeldung an und setzt dann die Ausführung fort.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-494">**Continue** : (Default) Displays the warning message and then continues executing.</span></span>
- <span data-ttu-id="1c2f9-495">**SilentlyContinue** : zeigt die Warnmeldung nicht an.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-495">**SilentlyContinue** : Doesn't display the warning message.</span></span> <span data-ttu-id="1c2f9-496">Setzt die Ausführung fort.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-496">Continues executing.</span></span>

#### <a name="examples"></a><span data-ttu-id="1c2f9-497">Beispiele</span><span class="sxs-lookup"><span data-stu-id="1c2f9-497">Examples</span></span>

<span data-ttu-id="1c2f9-498">Diese Beispiele zeigen die Auswirkung der verschiedenen Werte von `$WarningPreference` .</span><span class="sxs-lookup"><span data-stu-id="1c2f9-498">These examples show the effect of the different values of `$WarningPreference`.</span></span>
<span data-ttu-id="1c2f9-499">Der **WarningAction** -Parameter überschreibt den Preference-Wert.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-499">The **WarningAction** parameter overrides the preference value.</span></span>

<span data-ttu-id="1c2f9-500">Dieses Beispiel zeigt die Auswirkung des Standardwerts " **Continue** ".</span><span class="sxs-lookup"><span data-stu-id="1c2f9-500">This example shows the effect of the default value, **Continue**.</span></span>
...
<span data-ttu-id="1c2f9-501">In diesem Beispiel wird der **WarningAction** -Parameter mit dem Wert **SilentlyContinue** verwendet, um die Warnung zu unterdrücken.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-501">This example uses the **WarningAction** parameter with the value **SilentlyContinue** to suppress the warning.</span></span> <span data-ttu-id="1c2f9-502">Die Meldung wird nicht angezeigt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-502">The message isn't displayed.</span></span>
...
<span data-ttu-id="1c2f9-503">In diesem Beispiel wird die- `$WarningPreference` Variable in den **SilentlyContinue** -Wert geändert.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-503">This example changes the `$WarningPreference` variable to the **SilentlyContinue** value.</span></span> <span data-ttu-id="1c2f9-504">Die Meldung wird nicht angezeigt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-504">The message isn't displayed.</span></span>
...
<span data-ttu-id="1c2f9-505">In diesem Beispiel wird der **WarningAction** -Parameter verwendet, um zu beenden, wenn eine Warnung generiert wird.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-505">This example uses the **WarningAction** parameter to stop when a warning is generated.</span></span>
...
<span data-ttu-id="1c2f9-506">In diesem Beispiel wird die- `$WarningPreference` Variable **Inquire** in den Wert "suchen" geändert.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-506">This example changes the `$WarningPreference` variable to the **Inquire** value.</span></span> <span data-ttu-id="1c2f9-507">Der Benutzer wird zur Bestätigung aufgefordert.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-507">The user is prompted for confirmation.</span></span>
...
<span data-ttu-id="1c2f9-508">In diesem Beispiel wird der **WarningAction** -Parameter mit dem Wert **SilentlyContinue** verwendet.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-508">This example uses the **WarningAction** parameter with the value **SilentlyContinue**.</span></span> <span data-ttu-id="1c2f9-509">Der Befehl wird weiter ausgeführt, und es wird keine Meldung angezeigt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-509">The command continues to execute and no message is displayed.</span></span>
...
<span data-ttu-id="1c2f9-510">In diesem Beispiel wird der `$WarningPreference` Wert in " **beendet** " geändert.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-510">This example changes the `$WarningPreference` value to **Stop**.</span></span>
...
<span data-ttu-id="1c2f9-511">In diesem Beispiel wird die **WarningAction** mit **dem Wert "** suchen" verwendet.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-511">This example uses the **WarningAction** with the **Inquire** value.</span></span> <span data-ttu-id="1c2f9-512">Der Benutzer wird aufgefordert, wenn eine Warnung auftritt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-512">The user is prompted when a warning occurs.</span></span>
...
### <a name="whatifpreference"></a><span data-ttu-id="1c2f9-513">\$Variablen whatifpreference</span><span class="sxs-lookup"><span data-stu-id="1c2f9-513">\$WhatIfPreference</span></span>

<span data-ttu-id="1c2f9-514">Bestimmt, ob **WhatIf** für jeden Befehl, der ihn unterstützt, automatisch aktiviert wird.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-514">Determines whether **WhatIf** is automatically enabled for every command that supports it.</span></span> <span data-ttu-id="1c2f9-515">Wenn **WhatIf** aktiviert ist, meldet das Cmdlet die erwartete Auswirkung des Befehls, aber führt den Befehl nicht aus.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-515">When **WhatIf** is enabled, the cmdlet reports the expected effect of the command, but doesn't execute the command.</span></span>

<span data-ttu-id="1c2f9-516">Die folgenden Werte sind gültig:</span><span class="sxs-lookup"><span data-stu-id="1c2f9-516">The valid values are as follows:</span></span>

- <span data-ttu-id="1c2f9-517">**False** ( **0** , nicht aktiviert): (Standard) **WhatIf** ist nicht automatisch aktiviert.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-517">**False** ( **0** , not enabled): (Default) **WhatIf** isn't automatically enabled.</span></span> <span data-ttu-id="1c2f9-518">Um es manuell zu aktivieren, verwenden Sie den **WhatIf** -Parameter des Cmdlets.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-518">To enable it manually, use the cmdlet's **WhatIf** parameter.</span></span>
- <span data-ttu-id="1c2f9-519">**True** ( **1** , aktiviert): **WhatIf** wird automatisch für jeden Befehl aktiviert, der den Befehl unterstützt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-519">**True** ( **1** , enabled): **WhatIf** is automatically enabled on any command that supports it.</span></span> <span data-ttu-id="1c2f9-520">Benutzer können den **WhatIf** -Parameter mit dem Wert " **false** " verwenden, um ihn manuell zu deaktivieren, z `-WhatIf:$false` . b..</span><span class="sxs-lookup"><span data-stu-id="1c2f9-520">Users can use the **WhatIf** parameter with a value of **False** to disable it manually, such as `-WhatIf:$false`.</span></span>

#### <a name="examples"></a><span data-ttu-id="1c2f9-521">Beispiele</span><span class="sxs-lookup"><span data-stu-id="1c2f9-521">Examples</span></span>

<span data-ttu-id="1c2f9-522">Diese Beispiele zeigen die Auswirkung der verschiedenen Werte von `$WhatIfPreference` .</span><span class="sxs-lookup"><span data-stu-id="1c2f9-522">These examples show the effect of the different values of `$WhatIfPreference`.</span></span>
<span data-ttu-id="1c2f9-523">Sie zeigen, wie der **WhatIf** -Parameter verwendet wird, um den Einstellungs Wert für einen bestimmten Befehl zu überschreiben.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-523">They show how to use the **WhatIf** parameter to override the preference value for a specific command.</span></span>

<span data-ttu-id="1c2f9-524">Dieses Beispiel zeigt die Auswirkung der `$WhatIfPreference` Variablen auf den Standardwert **false**.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-524">This example shows the effect of the `$WhatIfPreference` variable set to the default value, **False**.</span></span> <span data-ttu-id="1c2f9-525">`Get-ChildItem`Überprüfen Sie mithilfe von, ob die Datei vorhanden ist.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-525">Use `Get-ChildItem` to verify that the file exists.</span></span>
<span data-ttu-id="1c2f9-526">`Remove-Item` Löscht die Datei.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-526">`Remove-Item` deletes the file.</span></span> <span data-ttu-id="1c2f9-527">Nachdem die Datei gelöscht wurde, können Sie den Löschvorgang mit überprüfen `Get-ChildItem` .</span><span class="sxs-lookup"><span data-stu-id="1c2f9-527">After the file is deleted, you can verify the deletion with `Get-ChildItem`.</span></span>
...
<span data-ttu-id="1c2f9-528">Dieses Beispiel zeigt die Auswirkung der Verwendung des **WhatIf** -Parameters, wenn der Wert von `$WhatIfPreference` **false** ist.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-528">This example shows the effect of using the **WhatIf** parameter when the value of `$WhatIfPreference` is **False**.</span></span>

<span data-ttu-id="1c2f9-529">Überprüfen Sie, ob die Datei vorhanden ist.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-529">Verify that the file exists.</span></span>
...
<span data-ttu-id="1c2f9-530">Verwenden Sie den **WhatIf** -Parameter, um das Ergebnis des Löschens der Datei zu bestimmen.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-530">Use the **WhatIf** parameter to determine the result of attempting to delete the file.</span></span>
...
<span data-ttu-id="1c2f9-531">Vergewissern Sie sich, dass die Datei nicht gelöscht wurde.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-531">Verify that the file wasn't deleted.</span></span>
...
<span data-ttu-id="1c2f9-532">In diesem Beispiel wird gezeigt, wie die `$WhatIfPreference` Variable auf den Wert **true** festgelegt ist.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-532">This example shows the effect of the `$WhatIfPreference` variable set to the value, **True**.</span></span> <span data-ttu-id="1c2f9-533">Wenn Sie `Remove-Item` zum Löschen einer Datei verwenden, wird der Pfad der Datei angezeigt, aber die Datei wird nicht gelöscht.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-533">When you use `Remove-Item` to delete a file, the file's path is displayed, but the file isn't deleted.</span></span>

<span data-ttu-id="1c2f9-534">Es wurde versucht, eine Datei zu löschen.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-534">Attempt to delete a file.</span></span> <span data-ttu-id="1c2f9-535">Es wird eine Meldung darüber angezeigt, was passieren würde `Remove-Item` , wenn ausgeführt würde, aber die Datei nicht gelöscht wird.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-535">A message is displayed about what would happen if `Remove-Item` was run, but the file isn't deleted.</span></span>
...
<span data-ttu-id="1c2f9-536">Verwenden `Get-ChildItem` Sie, um zu überprüfen, ob die Datei gelöscht wurde.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-536">Use `Get-ChildItem` to verify that the file wasn't deleted.</span></span>
...
<span data-ttu-id="1c2f9-537">Dieses Beispiel zeigt, wie eine Datei gelöscht wird, wenn der Wert von `$WhatIfPreference` **true** ist.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-537">This example shows how to delete a file when the value of `$WhatIfPreference` is **True**.</span></span> <span data-ttu-id="1c2f9-538">Er verwendet den **WhatIf** -Parameter mit dem Wert `$false` .</span><span class="sxs-lookup"><span data-stu-id="1c2f9-538">It uses the **WhatIf** parameter with a value of `$false`.</span></span> <span data-ttu-id="1c2f9-539">Verwenden `Get-ChildItem` Sie zum Überprüfen, ob die Datei gelöscht wurde.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-539">Use `Get-ChildItem` to verify the file was deleted.</span></span>
...
<span data-ttu-id="1c2f9-540">Im folgenden finden Sie Beispiele für das `Get-Process` Cmdlet, das **WhatIf** nicht unterstützt, und `Stop-Process` das **WhatIf** unterstützt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-540">The following are examples of the `Get-Process` cmdlet that doesn't support **WhatIf** and `Stop-Process` that does support **WhatIf**.</span></span> <span data-ttu-id="1c2f9-541">Der `$WhatIfPreference` Wert der Variablen ist " **true** ".</span><span class="sxs-lookup"><span data-stu-id="1c2f9-541">The `$WhatIfPreference` variable's value is **True**.</span></span>

<span data-ttu-id="1c2f9-542">`Get-Process` unterstützt **WhatIf** nicht.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-542">`Get-Process` doesn't support **WhatIf**.</span></span> <span data-ttu-id="1c2f9-543">Wenn der Befehl ausgeführt wird, wird der **Winword** -Prozess angezeigt.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-543">When the command is executed, it displays the **Winword** process.</span></span>
...
<span data-ttu-id="1c2f9-544">`Stop-Process` unterstützt **WhatIf**.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-544">`Stop-Process` does support **WhatIf**.</span></span> <span data-ttu-id="1c2f9-545">Der **Winword** -Prozess wurde nicht beendet.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-545">The **Winword** process isn't stopped.</span></span>
...
<span data-ttu-id="1c2f9-546">Sie können das `Stop-Process` **WhatIf** -Verhalten überschreiben, indem Sie den **WhatIf** -Parameter mit einem Wert von verwenden `$false` .</span><span class="sxs-lookup"><span data-stu-id="1c2f9-546">You can override the `Stop-Process` **WhatIf** behavior by using the **WhatIf** parameter with a value of `$false`.</span></span> <span data-ttu-id="1c2f9-547">Der **Winword** -Prozess wird beendet.</span><span class="sxs-lookup"><span data-stu-id="1c2f9-547">The **Winword** process is stopped.</span></span>

```powershell
Stop-Process -Name Winword -WhatIf:$false
```

<span data-ttu-id="1c2f9-548">Verwenden Sie, um zu überprüfen, ob der **Winword** -Prozess beendet wurde `Get-Process` .</span><span class="sxs-lookup"><span data-stu-id="1c2f9-548">To verify that the **Winword** process was stopped, use `Get-Process`.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="1c2f9-549">Weitere Informationen:</span><span class="sxs-lookup"><span data-stu-id="1c2f9-549">See also</span></span>

[<span data-ttu-id="1c2f9-550">about_Automatic_Variables</span><span class="sxs-lookup"><span data-stu-id="1c2f9-550">about_Automatic_Variables</span></span>](about_Automatic_Variables.md)

[<span data-ttu-id="1c2f9-551">about_CommonParameters</span><span class="sxs-lookup"><span data-stu-id="1c2f9-551">about_CommonParameters</span></span>](about_CommonParameters.md)

[<span data-ttu-id="1c2f9-552">about_Environment_Variables</span><span class="sxs-lookup"><span data-stu-id="1c2f9-552">about_Environment_Variables</span></span>](about_Environment_Variables.md)

[<span data-ttu-id="1c2f9-553">about_Profiles</span><span class="sxs-lookup"><span data-stu-id="1c2f9-553">about_Profiles</span></span>](about_Profiles.md)

[<span data-ttu-id="1c2f9-554">about_Remote</span><span class="sxs-lookup"><span data-stu-id="1c2f9-554">about_Remote</span></span>](about_Remote.md)

[<span data-ttu-id="1c2f9-555">about_Scopes</span><span class="sxs-lookup"><span data-stu-id="1c2f9-555">about_Scopes</span></span>](about_Scopes.md)

[<span data-ttu-id="1c2f9-556">about_Variables</span><span class="sxs-lookup"><span data-stu-id="1c2f9-556">about_Variables</span></span>](about_Variables.md)
