...
**Stream** ist ein dynamischer Parameter, den der File System-Anbieter hinzufügt `Clear-Content` . Dieser Parameter funktioniert nur in Dateisystem Laufwerken und löscht den Inhalt alternativer Datenströme in Dateien und Verzeichnissen.
...
Dieser Parameter wurde in PowerShell 3,0 eingeführt. Ab PowerShell 7,2 `Clear-Content` kann den Inhalt alternativer Datenströme aus Verzeichnissen und Dateien löschen.
