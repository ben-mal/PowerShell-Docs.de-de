...
`Enter-PSHostProcess`Mit dem-Cmdlet wird eine Verbindung mit einer interaktiven Sitzung hergestellt und mit einem lokalen Prozess verknüpft. Ab PowerShell 6,2 wird dieses Cmdlet auf nicht-Windows-Plattformen unterstützt.
...
Ruft den Namen des benutzerdefinierten Named Pipe für die Verbindung ab oder legt ihn fest. Dies wird in der Regel in Verbindung mit verwendet `pwsh -CustomPipeName` .
